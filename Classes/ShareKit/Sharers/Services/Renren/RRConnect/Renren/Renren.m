...
+ (Renren *)newRenRen{
    ...
    newRenrenObject.appKey = SHKRenRenConsumerKey;
    newRenrenObject.appId = SHKRenRenConsumerKey;
...
+ (Renren *)sharedRenren {
    if (!sharedRenren) {
        ...
        sharedRenren.appKey = SHKRenRenConsumerKey;
        sharedRenren.appId = SHKRenRenConsumerKey;
    }
    return sharedRenren;
}
